...
exports.getAndInjectLicense = exports.earlyInjectionCheck = exports.getLicense = exports.getAndInjectLivePatch = exports.injectLivePatch = exports.getPatch = exports.create = exports.screenshot = void 0;
...
const pkg = fs_extra_1.readJsonSync(path.join(__dirname, '../../package.json')), configWithCases = fs_extra_1.readJsonSync(path.join(__dirname, '../../bin/config-schema.json')), timeout = (ms) => {

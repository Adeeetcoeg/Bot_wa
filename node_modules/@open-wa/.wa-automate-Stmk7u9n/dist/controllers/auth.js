...
const waitForRipeSession = (waPage) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield waPage.waitForFunction(`!![...document.getElementsByTagName('div')].map(div=>Object.keys(div).filter(k=>k.includes('__reactFiber'))[0] ? div[Object.keys(div).filter(k=>k.includes('__reactFiber'))[0]].return.type : false).filter(x=>x && x['displayName']==='IntroPanel')[0]`);
        return true;
    }
    catch (error) {
        return false;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const grabAndEmit = (qrData) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                //@ts-ignore
                console.log(yield waPage.evaluate("window.launchres"));
        ...
        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
            ...
            const fn = (qrData) => __awaiter(this, void 0, void 0, function* () {
                if (!gotResult && (qrData === 'QR_CODE_SUCCESS' || qrData === 'MULTI_DEVICE_DETECTED')) {
                    gotResult = true;
                    spinner === null || spinner === void 0 ? void 0 : spinner.succeed(qrData === 'MULTI_DEVICE_DETECTED' ? "Multi device support for this project is EXPERIMENTAL. Some things may not work...." : "QR code scanned. Loading session...");
